...
def create_dash_application(flask_app):
    app= dash.Dash(__name__ , server=flask_app, name="Dashboard", url_base_pathname="/dash/" , meta_tags=[{"name": "viewport", "content": "width=device-width"}],external_stylesheets=['assets/style.css'])
    app.layout = html.Div((
    html.Div([
        html.Div([
            html.Div([
